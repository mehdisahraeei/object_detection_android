...
import com.object_detection_android.databinding.ActivityYolov1Binding
...
class YolovOneActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var binding: ActivityYolov1Binding
...
// Draw the detection result on the bitmap and show it.
    ...
    override fun onBackPressed() {
        startActivity(Intent(this@YolovOneActivity, MainActivity::class.java))
    }
